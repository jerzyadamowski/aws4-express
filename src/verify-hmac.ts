// import { BinaryLike, BinaryToTextEncoding, createHmac, KeyObject, timingSafeEqual } from 'crypto';
...
//   getDigest: (req: TRequest) => WithImplicitCoercion<string | Uint8Array | readonly number[]> | undefined;
...
//     try {
//       if (!timingSafeEqual(Buffer.from(receivedDigest), Buffer.from(computedHmac.digest(encoding)))) {
